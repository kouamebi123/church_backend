...
router.post('/:id/image', authorize('ADMIN', 'MANAGER', 'COLLECTEUR_RESEAUX'), authorizeUserModification, profileImageUpload.single('image'), userController.uploadUserImage);
...
router.get('/retired', userController.getRetiredUsers);
...
router.post('/:id/reset-password', authorize('ADMIN', 'MANAGER', 'COLLECTEUR_RESEAUX'), userController.resetPassword);
